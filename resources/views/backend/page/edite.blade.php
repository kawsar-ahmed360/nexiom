                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form role="form" method="post" action="{{ route('PageUpdate',$page->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="{{ asset('upload/page/'.$page->image) }}" class="img-thumbnail" width="100" height="100" />
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="collapse" id="collapseExample">
                                                    <div class="card card-body">
                                                        ...
                                                        <input type="text" name="meta_title" class="form-control" value="{{@$page->meta_title}}" placeholder="enter meta title">


                                                        <label for="">Meta Description</label>
                                                        <textarea name="meta_des" class="form-control" id="" cols="2" rows="3" placeholder="Enter Meta description">{!! @$page->meta_des !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
