                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form role="form" method="post" action="{{route('ProductCategoryUpdate',$edite->id)}}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="category_name" value="{{@$edite->category_name}}" placeholder="Category" />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="brand_name" value="{{@$edite->brand_name}}" placeholder="brand_name" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <img style="width: 100px;" src="{{(@$edite->category_image)?url('upload/category_image/'.@$edite->category_image):''}}" alt="">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <img style="width: 100px;" src="{{(@$edite->brand_image)?url('upload/Brand/'.@$edite->brand_image):''}}" alt="">
                                                </div>
                                            </div>
