        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2>All Partners</h2>
                        <a style="float:right"  data-toggle="modal" data-target="#exampleModal" class="btn btn-primary square-btn-adjust">Add Partners</a>
                        <div class="row">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        @foreach($index as $key=>$socials)
                                            <tr class="odd gradeX">
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $socials->url }}</td>
                                                <td><img style="width: 100px;" src="{{(@$socials->image)?url('upload/Partners/'.@$socials->image):''}}" alt=""></td>
                                                ...
                                                <td><a data-toggle="modal" data-target="#exampleModalEdite{{@$key}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                                    ...
                                                    <a href="{{route('ParnersDelete',$socials->id)}}" id="delete" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('ParnersStore')}}" method="post" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="modal fade" id="exampleModalEdite{{@$key}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('ParnersUpdate')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <img style="width: 100px;" src="{{(@$socials->image)?url('upload/Partners/'.@$socials->image):''}}" alt="">
